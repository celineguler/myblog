...
A physical mystery part explains why we call it dark, but we can also ask that why do we also classify it as "matter"? We define matter as *Matter is anything that takes up space and can be weighed.* in the most accepted case.
